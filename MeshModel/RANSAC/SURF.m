function [source_features,target_features,state] = SURF(I1,I2)
    ...
    [~,inliners,state] = EstimateHomographyByRANSAC(source_features',target_features', 0.001);
    if state == 1 % cannot track feature
        return;
    end
